...
//print_r($arResult["COMPANY_OFFICES"]);
...
<?
	...
	// add coords and text from infoblock company_offices
	foreach ($arResult["COMPANY_OFFICES"] as $key => $office) {
		$arResult['POSITION']["PLACEMARKS"][] = $office;
	}
