...
if ( ! function_exists( 'fashify_footer_site_info' ) ) {
    ...
    function fashify_footer_site_info()
    {
		...
		<div class="theme-info-text">
        	<a href="https://www.famethemes.com/" rel="designer">Fashify</a> / <a href="http://wp-templates.ru/" title="Шаблоны WordPress">Шаблоны</a> / <a href="https://rastenievod.com/" title="Комнатные цветы и растения" target="_blank">Растения</a>
		</div>
		<?php
    }
}
